...
public class CartController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "accessToken",value = "登录后的访问令牌，没有登录不用传")
    })
     ...
     * @return
     */
    @ApiOperation("购物项选中与不选中")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "skuIds",value = "所有操作商品的skuId的集合，多个商品的id用逗号分割"),
            @ApiImplicitParam(name = "ops",value = "1:代表选中，0：代表不选中"),
            @ApiImplicitParam(name = "cartKey",value = "离线购物车key，可以没有"),
            @ApiImplicitParam(name = "accessToken",value = "登录后的访问令牌，没有登录不用传")
    })
    ...
    public CommonResult cartCheck(@RequestParam("skuIds") String skuIds,
        ...
        CartResponse cartResponse = cartService.checkCartItem(skuIds,ops,cartKey,accessToken);
